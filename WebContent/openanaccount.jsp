...
<body class="bgstyle"
	...
	<form name="createaccount" action="redirectCreatePage.jsp"
		method="POST" onsubmit="return validnew();">
		...
		<table border="0" align="center">
			<tbody>
				...
				<tr>
					...
					<td><input type="radio" name="disp" value="0"
		...
		<table border="0" align="center">
			<tr>
				<td align="center"><p>Please click on "Create" to get your
						account id(s)</p></td>
			</tr>
			<tr>
				<td align="center"><p>Your account id/user id will be
						automatically generated after validating your personal information</p></td>
			</tr>
		</table>
	</form>
</body>
